...
public class MySQLBankBranchOfficeDAO extends MySQLDAO implements IBankBranchOfficeDAO {
    ...
    private final static String OFFICE_BY_CLIENT_ID = "SELECT * FROM bank_solvd.BANK_BRANCH_OFFICE INNER JOIN bank_solvd.CLIENT ON BANK_BRANCH_OFFICE.OFFICE_ID = CLIENT.OFFICE_ID WHERE CLIENT_ID = ?";
