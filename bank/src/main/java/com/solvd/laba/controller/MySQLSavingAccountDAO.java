...
public class MySQLSavingAccountDAO extends MySQLDAO implements ISavingAccountDAO {
    ...
    private final static String SAVING_BY_CLIENT_ID = "SELECT * FROM SAVING_ACCOUNT INNER JOIN bank_solvd.CLIENT ON SAVING_ACCOUNT.SAVING_ACCOUNT_ID = CLIENT.SAVING_ACCOUNT_ID WHERE CLIENT_ID = ?";
